...
public class GameOverScene extends Scene
{
    ...
    public void init() 
    {
        ...
        gameObjects.add(g);
        g = new GameObject("eyes", new Transform(new Vector2(0, -50)));
        g.addComponent(AssetPool.getSprite("assets/eyes.png"));
        gameObjects.add(g);
        GameObject gameOver = new GameObject("", new Transform(new Vector2(Constants.SCREEN_WIDTH/2-228, Constants.SCREEN_HEIGHT/2-104)));
        gameOver.transform.scale = new Vector2(6.0f, 6.0f);
        gameOver.addComponent(AssetPool.getSprite("assets/gameOver.png"));
